...
const PERIODIC_REFERENCE_IMAGE = require("../../assets/periodic-table/periodic-table-reference.png");
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.referenceCard}>
        <Text style={styles.referenceTitle}>{lang === "ru" ? "Опорная схема" : "Reference layout"}</Text>
        <Text style={styles.referenceText}>
          {lang === "ru"
            ? "Сверяйте группы, периоды и семейства по полной схеме, затем выбирайте элементы ниже для подробной карточки."
            : "Use the full layout as a reference, then select elements below for details."}
        </Text>
        <Image source={PERIODIC_REFERENCE_IMAGE} style={styles.referenceImage} resizeMode="contain" />
      </View>
