...
export default function Page() {
  return (
    <main className="module-shell">
      <SectionHeader eyebrow="physics" title="Physics module foundation" description="Formula-driven simulations, variables, graphs and future physics scene placeholders." />
